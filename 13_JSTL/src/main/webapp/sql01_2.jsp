...
<body>
	...
	<%
		...
		for( SortedMap row : rows ) {
			...
			LocalDateTime createdLDT = (LocalDateTime) row.get("created_at");
			Date createdAt = Date.from(createdLDT.atZone(ZoneId.systemDefault()).toInstant());
			board.setCreatedAt( createdAt );
			LocalDateTime updatedLDT = (LocalDateTime) row.get("updated_at");
			Date updatedAt = Date.from(createdLDT.atZone(ZoneId.systemDefault()).toInstant());
